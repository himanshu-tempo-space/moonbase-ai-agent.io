...
async function createPeerConnection(offer, iceServers) {
  ...
  dc.onmessage = (event) => {
    ...
    let response = decodedMsg
    if (msg.includes("chat/partial:")) {
      // console.log(decodedMsg)
      msg = decodeURIComponent(msg.replace("chat/partial:", ""))
...
function playIdleVideo() {
  ...
  videoElement.src = 'idle_vashnavi.mp4';
...
async function connectToPeer  () {
  ...
  const sessionResponse = await fetchWithRetries(`${DID_API.url}/${DID_API.service}/streams`, {
    ...
    body: JSON.stringify({
      source_url: 'https://iili.io/JN4vxta.jpg'
    }),
  });
...
startButton.onclick = async () => {
  ...
  if (peerConnection?.signalingState === 'stable' || peerConnection?.iceConnectionState === 'connected') {
    ...
    // TODO: change picture used for each user
    document.getElementById("msgHistory").innerHTML += `
      <div class="chat-bubble out-chat">
        <div class="chat-sender">
          <img class="chat-sender-img" src="emma_idle.png" width="20" height="20" type="image" />
          <p class="chat-sender-name">You</p>
        </div>
        <p class="chat-msg">
          ${textArea.value}
        </p>
  ...
  const createAgent = await axios.post('/agents',
    {
      "knowledge": {
        ...
        "id": "knl_h7FZqw7PPJkH6x2OjYHyJ"
      },
      "presenter": {
        "type": "talk",
        "voice": {
          "type": "elevenlabs",
          "voice_id": "NCc02xd2TFqrlXLlSNoG"
        },
        "thumbnail": "https://iili.io/JN4vxta.jpg",
        "source_url": "https://iili.io/JN4vxta.jpg"
      },
      "llm": {
        "type": "openai",
        ...
        "instructions": "Your name is Vaishnavi, an AI designed to assist with HR tasks and onboarding/training practices"
      },
      "preview_name": "Vaishnavi"
    }
...
// Emma///
//  agentId='agt_hp-YVVlX';
//  chatId='cht_9Zt0dERsYep0LyO6kdwDx';
 
// Vaishnavi/// 
agentId= "agt_uAb_wGuy"
chatId="cht_eZQVPrGbAlWdSlVjXpWpt"